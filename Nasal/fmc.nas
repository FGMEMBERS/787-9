var fmc = {
	...
	get_climb_vs: func(altitude) {
		...
		if (altitude < 10000)
			vs_climb = 2750;
		else if ((altitude >= 10000) and (altitude < 30000))
			vs_climb = 2250;
		else
			vs_climb = 1000;
		return vs_climb;
	...
	round_climb_alts: func(target_altitude, direction) {
		if (direction == "East"){
			...
			else if ((target_altitude >= 2000) and (target_altitude < 4000))
				target_altitude = 3000;
			else if ((target_altitude >= 4000) and (target_altitude < 6000))
				target_altitude = 5000;
			else if ((target_altitude >= 6000) and (target_altitude < 8000))
				target_altitude = 7000;
			else if ((target_altitude >= 8000) and (target_altitude < 10000))
				target_altitude = 9000;
			else if ((target_altitude >= 10000) and (target_altitude < 12000))
				target_altitude = 11000;
			else if ((target_altitude >= 12000) and (target_altitude < 14000))
				target_altitude = 13000;
			else if ((target_altitude >= 14000) and (target_altitude < 16000))
				target_altitude = 15000;
			else if ((target_altitude >= 16000) and (target_altitude < 18000))
				target_altitude = 17000;
			else if ((target_altitude >= 18000) and (target_altitude < 20000))
				target_altitude = 19000;
			else if ((target_altitude >= 20000) and (target_altitude < 22000))
				target_altitude = 21000;
			else if ((target_altitude >= 22000) and (target_altitude < 24000))
				target_altitude = 23000;
			else if ((target_altitude >= 24000) and (target_altitude < 26000))
				target_altitude = 25000;
			else if ((target_altitude >= 26000) and (target_altitude < 28000))
				target_altitude = 27000;
			else if ((target_altitude >= 28000) and (target_altitude < 30000))
				target_altitude = 29000;
			else if ((target_altitude >= 30000) and (target_altitude < 32000))
				target_altitude = 31000;
			else if ((target_altitude >= 32000) and (target_altitude < 34000))
				target_altitude = 33000;
			else if ((target_altitude >= 34000) and (target_altitude < 36000))
				target_altitude = 35000;
			else if ((target_altitude >= 36000) and (target_altitude < 38000))
				target_altitude = 37000;
			else if ((target_altitude >= 38000) and (target_altitude < 40000))
			...
			else if ((target_altitude >= 3000) and (target_altitude < 5000))
				target_altitude = 4000;
			else if ((target_altitude >= 5000) and (target_altitude < 7000))
				target_altitude = 6000;
			else if ((target_altitude >= 7000) and (target_altitude < 9000))
				target_altitude = 8000;
			else if ((target_altitude >= 9000) and (target_altitude < 11000))
				target_altitude = 10000;
			else if ((target_altitude >= 11000) and (target_altitude < 13000))
				target_altitude = 12000;
			else if ((target_altitude >= 13000) and (target_altitude < 15000))
				target_altitude = 14000;
			else if ((target_altitude >= 15000) and (target_altitude < 17000))
				target_altitude = 16000;
			else if ((target_altitude >= 17000) and (target_altitude < 19000))
				target_altitude = 18000;
			else if ((target_altitude >= 19000) and (target_altitude < 21000))
				target_altitude = 20000;
			else if ((target_altitude >= 21000) and (target_altitude < 23000))
				target_altitude = 22000;
			else if ((target_altitude >= 23000) and (target_altitude < 25000))
				target_altitude = 24000;
			else if ((target_altitude >= 25000) and (target_altitude < 27000))
				target_altitude = 26000;
			else if ((target_altitude >= 27000) and (target_altitude < 29000))
				target_altitude = 28000;
			else if ((target_altitude >= 29000) and (target_altitude < 31000))
				target_altitude = 30000;
			else if ((target_altitude >= 31000) and (target_altitude < 33000))
				target_altitude = 32000;
			else if ((target_altitude >= 33000) and (target_altitude < 35000))
				target_altitude = 34000;
			else if ((target_altitude >= 35000) and (target_altitude < 37000))
				target_altitude = 36000;
			else if ((target_altitude >= 37000) and (target_altitude < 39000))
